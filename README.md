...
`mix phoenix.gen.json ProfileParameter profileparameters profile:integer parameter:integer`
`mix phoenix.gen.html --no-model HtmlProfileParameter profileparameters profile:integer parameter:integer`

`mix phoenix.gen.json ProfileParameter profileparameters profile:integer parameter:integer`
`mix phoenix.gen.html --no-model HtmlProfileParameter profileparameters profile:integer parameter:integer`

`mix phoenix.gen.json Profile profiles name:string description:string`
`mix phoenix.gen.html --no-model HtmlProfile profiles name:string description:string`
...
`mix phoenix.gen.json Type types name:string description:string use_in_table:string`
`mix phoenix.gen.html --no-model HtmlType types name:string description:string use_in_table:string`
#### Testing
